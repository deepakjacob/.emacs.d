...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(guide-key/key-face ((t (:foreground "#C586C0"))))
 '(guide-key/prefix-command-face ((t (:foreground "cyan"))))
 '(mode-line-buffer-id ((t (:foreground "#C586C0" :weight bold))))
