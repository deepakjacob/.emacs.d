...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(guide-key/key-face ((t (:foreground "#ce9178"))))
 '(guide-key/prefix-command-face ((t (:foreground "cyan"))))
 '(linum ((t (:foreground "gray22"))))
 '(mode-line-buffer-id ((t (:foreground "#51afef" :weight bold))))
 '(mode-line-inactive ((t (:foreground "#5B6268" :box nil))))
 '(powerline-active0 ((t (:inherit mode-line :background "gray0" :foreground "#51afef"))))
 '(powerline-active1 ((t (:inherit mode-line :background "gray0" :foreground "#fad07a"))))
 ...
 '(powerline-inactive2 ((t (:inherit mode-line-inactive :background "grey0")))))
