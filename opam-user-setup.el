...
;; ## added by OPAM user-setup for emacs / tuareg ## c1dd5699641ea3412d04e34b3fb1ab95 ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/Users/jacobdeepak/.opam/default/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
